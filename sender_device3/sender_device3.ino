...
// --- NODE CONFIGURATION ---
const char NODE_ID[16] = "Fridge"; // Change to "node_2", "node_3", "node_4" for other nodes
...
void loop() {
  ...
  float voltage = 220.0; // Simulated Voltage
  float current = 2;  // Simulated Current in Amps
